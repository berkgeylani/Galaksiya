...
public class RssReaderTest {
	...
	private boolean areEqual(FeedMessage message,FeedMessage message2){
		...
		boolean isPubDateEqual = message1pubdate.equals(message2pubdate);//Tue, 21 Jun 2016 13:16:16----Tue Jun 21 13:16:16 EEST 2016
	...
	public void canReadrssReader() throws MalformedURLException{ // true rss,link,new 4
		...
		message.setPubDate("Tue, 21 Jun 2016 13:16:16"
				+ "");
